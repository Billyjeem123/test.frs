                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="facility-item">
                            <div class="facility-icon bg-primary position-relative" style="position: relative; width: 100px; height: 100px; border-radius: 50%; overflow: hidden; display: flex; justify-content: center; align-items: center;">
                                ...
                                <img src="{{ asset('images/' . $sponsor->logo) }}" alt="Sponsor Logo" style="width: 100%; height: 100%; object-fit: cover; object-position: center;">
                                <span class="bg-primary"></span>
                            </div>
                            <div class="facility-text bg-primary">
                                <h3 class="text-primary mb-3">{{$sponsor->company_name}}</h3>
{{--                                <p class="mb-0">{{$sponsor->message}}</p>--}}
                            </div>
                        </div>
